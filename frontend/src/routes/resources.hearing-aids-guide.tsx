...
export const Route = createFileRoute("/resources/hearing-aids-guide")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Your guide to hearing aids: how they work, styles, care tips, and common myths." },
      { property: "og:title", content: "Your Guide to Hearing Aids" },
      { property: "og:description", content: "How hearing aids work, styles, care and success tips." },
    ],
  }),
  component: () => (
    <div className="min-h-screen bg-background">
      ...
      <Prose>
        <h2>How they work</h2>
        <p>Modern hearing aids are small, comfortable, and technologically advanced. They amplify the sounds you need to hear, filter background noise, and can even connect to your phone, TV, and tablet via Bluetooth. Your audiologist will program the device to match your hearing loss and lifestyle.</p>
        ...
        <h2>Common myths</h2>
        <ul>
          <li><strong>"Hearing aids make everything too loud."</strong> Modern devices balance sounds naturally.</li>
          <li><strong>"Only older people need them."</strong> Hearing loss can affect anyone, at any age.</li>
        </ul>
      </Prose>
      <Footer />
    </div>
