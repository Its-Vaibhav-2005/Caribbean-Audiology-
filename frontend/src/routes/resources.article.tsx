      ...
      <div className="py-16">
        ...
        <section className="mx-auto max-w-4xl px-5 sm:px-8 mb-16">
          ...
          <p className="text-lg text-foreground/80 leading-relaxed font-medium">
            At our clinic, we believe that advancing hearing health means combining compassionate patient care with cutting-edge research. Dr. Sidheshwar Pandey’s work bridges science and practice—exploring new therapies for tinnitus, pioneering genetic approaches to hearing loss, and highlighting holistic methods that empower patients in their daily lives. By sharing these insights, we aim to keep our community informed, inspired, and confident that the future of hearing care is full of possibility.
          </p>
        </section>
        ...
        <section className="w-full overflow-hidden bg-teal/5 py-12 mb-16 border-y border-teal/10 relative">
          <div className="mx-auto max-w-7xl px-5 sm:px-8 mb-6">
            <h3 className="font-display text-2xl text-teal font-semibold">Publications & Studies</h3>
        ...
        <section className="mx-auto max-w-4xl px-5 sm:px-8">
          <div className="bg-card border border-border/60 rounded-3xl p-8 sm:p-10 shadow-sm relative overflow-hidden">
            ...
            <blockquote className="italic text-lg text-foreground/90 leading-relaxed font-medium">
              "Dr. Pandey’s work in genomics extends beyond agriculture into hearing health. By applying next-generation sequencing techniques, his research helps identify genetic causes of hearing loss and opens the door to personalized treatments. This approach not only improves diagnosis today but also lays the foundation for future therapies such as gene therapy and stem cell regeneration."
            </blockquote>
          </div>
        </section>
      </div>
...
const CARDS: Card[] = [
  ...
  },
  {
    ...
    summary: "This chapter explores Bhramari Pranayama (a yogic breathing technique) as a complementary therapy for tinnitus. Dr. Pandey emphasizes the importance of holistic approaches alongside conventional audiological care. The work discusses how controlled breathing and mindfulness can reduce stress, improve neural regulation, and potentially alleviate tinnitus symptoms.",
    keyPoint: "The chapter advocates for integrating alternative therapies with clinical management to enhance patient outcomes, especially in cases where traditional treatments provide limited relief."
  },
  {
    icon: Dna,
    ...
    summary: "This chapter reviews genetic causes of hearing loss and emerging diagnostic tools. It highlights the role of clinical exome sequencing in identifying mutations in genes such as GJB2, MYO7A, CDH23, OTOF, SLC26A4, and TMC1. Dr. Pandey discusses the promise of gene therapy and stem cell treatments for cochlear hair cell regeneration, while noting that these therapies are still in early stages.",
    keyPoint: "The article underscores the importance of preventive measures and genetic testing as immediate strategies, while positioning regenerative medicine as the future of hearing restoration."
  },
  {
    icon: Sprout,
  ...
  return (
    <div className="w-[360px] sm:w-[440px] bg-card border border-border/60 hover:border-teal/40 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all flex flex-col justify-between shrink-0">
      <div>
        ...
        <h4 className="font-sans text-base font-bold text-teal leading-snug mb-3">
          {card.title}
        </h4>
        ...
        <div className="space-y-3">
          <p className="text-xs text-foreground/80 leading-relaxed">
            <strong className="text-foreground text-[11px] block uppercase tracking-wider mb-0.5">Summary</strong>
            {card.summary}
          </p>
          <p className="text-xs text-foreground/80 border-t border-border/40 pt-2 leading-relaxed">
            <strong className="text-foreground text-[11px] block uppercase tracking-wider mb-0.5">Key Point / Insight</strong>
            {card.keyPoint}
          </p>
        </div>
      </div>
